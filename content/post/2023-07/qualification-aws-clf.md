...
まず始めに、ざっとAWS全体の基本を抑えるため、参考書の「[AWS認定資格試験テキスト クラウドプラクティショナー](https://amzn.to/4bWepqa)」を一周通して読みました。通称緑本と呼ばれており、最初の取っ掛かりとしては良い参考書だと思います。載っている練習問題の数は多くはありませんでした。新版が出ているので、そちらを紹介します。

{{< product_link title="AWS認定資格試験テキスト AWS認定 クラウドプラクティショナー　改訂第3版" image="https://m.media-amazon.com/images/I/51mcXFkD2kL._SL160_.jpg" url="https://amzn.to/4bWepqa">}}
